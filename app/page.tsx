...
import { Loader2, ChevronLeft, ChevronRight, Settings, Check, TrendingUp, Calendar } from 'lucide-react';
    ...
    <div className="bg-[#F8F9FA] min-h-screen font-sans">
      ...
      >
        <div className="relative h-full flex flex-col justify-between max-w-xl mx-auto px-5">
            ...
            {/* 3. SELETOR DE DATA (Footer do Header) */}
                        ...
                        return (
                          <div key={cat}>
                            <div className="flex justify-between text-xs mb-1.5">
                              ...
                              {/* CORREÇÃO DO CLASSNAME AQUI: */}
                              <span className="text-secondary font-medium">
                                {formatCurrency(val)} <span className="text-gray-300 ml-1 text-[10px]">({pct.toFixed(0)}%)</span>
                              </span>
                            </div>
