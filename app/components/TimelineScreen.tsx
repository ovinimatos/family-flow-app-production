      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-gray-100 sticky top-0 z-20 shadow-sm transition-all rounded-b-[2rem]">
        ...
        <div className="px-6 pb-6 pt-2">
          ...
          <div className="relative h-3 w-full bg-gray-100 rounded-full overflow-hidden shadow-inner border border-gray-100">
            <div className={`absolute top-0 left-0 h-full rounded-full transition-all duration-1000 ease-out ${progressWidth >= 99.9 ? 'success-gradient' : 'progress-gradient'}`} style={{ width: `${progressWidth}%` }}>
              <div className="absolute right-0 top-0 h-full w-3 bg-white/30 blur-[3px]"></div>
            </div>
          </div>
